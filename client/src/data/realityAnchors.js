...
export const statewideFacts = [
  {
    ...
    interpretation:
      "Most students remain below Mastery+. This suggests room for targeted academic support."
  },
  {
    id: "graduation",
    ...
    sourceType: "Public source",
    interpretation:
      "Graduation rates are improving, but pathway alignment still matters for workforce readiness."
  },
  {
    id: "performance",
    ...
    sourceType: "Public source",
    interpretation: "State performance is improving, but school-level and parish-level gaps remain."
  },
  {
    id: "healthcare",
...
export const productNarrative = {
  problemTitle: "What does this solve?",
  problemLead:
    "Louisiana has education, workforce, and demographic data, but it lives in different systems. LALens brings it together so funders and operators can see where a new program could matter most.",
  workflowTitle: "LALens is a decision workflow.",
  workflowLead:
    "It helps users move from scattered public data to a ranked investment brief that explains the need, the opportunity, the risk, and the next action.",
  prototypeNote:
...
export const problemMiniCards = [
  {
    ...
    body: "School performance, enrollment, poverty, and workforce projections live in different systems."
  },
  {
...
export const scoreFactorHelp = {
  ...
  workforceGap: "Uses regional workforce-demand categories informed by LWC public reporting.",
...
export const dataStatusRows = [
  ...
  { layer: "Census demographics (ACS 5-Year)", status: "Live public API", usedFor: "Poverty, income, population, transportation-access context" },
